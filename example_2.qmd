...
```{r}
# compare the standard 3 predictor model with the MM with 2 predictors 
model.comparison(lm3, mod_ses_minority)
```

#### Comments

-   MM still better than standard 3 predictor variable model?
