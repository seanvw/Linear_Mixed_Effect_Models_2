...
Compare models with data set 'math'. Apart from the regular flow from DF, added are sections on data set understanding together with a delve into using regular GLM (General not Generalized!) and some funky vizualisations of multifactorial models.
