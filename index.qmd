...
Always wanted to find a chuck of time to refine my statistical modelling knowledge beyond General Linear Models and Generalized Linear Models. So finally it's here in association with Quarto and GitHub so that notes, code and examples are online for future reference (for a quicker push to brain RAM).
